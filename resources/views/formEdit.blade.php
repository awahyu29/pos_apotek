...
<div class="row">
    ...
    <div class="col-xl-6">
        <div class="form-group">
            <label class="form-control-label">{{ __('NIK') }}</label>
            <div class="input-group input-group-merge">
                <input type="text" value="{{ $user->nik }}" class="form-control" name="nik" placeholder="NIK"
...
<div class="row">
    <div class="col-xl-12">
        <div class="form-group">
            <label class="form-control-label">{{ __('NPWP') }}</label>
            <div class="input-group input-group-merge">
                <input type="text" value="{{ $user->npwp }}" class="form-control" name="npwp" placeholder="NPWP"
                    maxlength="15" required>
                @error('npwp')
                    <small class="text-danger" role="alert">
                        {{ $message }}
