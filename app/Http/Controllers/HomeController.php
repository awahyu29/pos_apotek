...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $today = Carbon::now (); $today->month;
        $keuntungan = barang_keluar::where('created_at', $today)->count('harga');
        $auth = auth()->user();
        ...
        if ($auth->hasRole('admin')) {
            ...
            'response','suplier','keuntungan','barang','users','departements','checkProfil'
            ));
            ...
            return view('home', compact(
            'response','users','suplier','barang','departements','checkProfil'
            ));

        } else if ($auth->hasRole('user')) {
            return view('home', compact(
            'response','barang','checkProfil'
            ));
        }
    }
