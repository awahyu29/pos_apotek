            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('barangmasuk.index') }}" class="btn btn-sm btn-neutral">Back</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Edit Barang Masuk</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form method="POST" action="{{ route('barangmasuk.update', $barangmasuk->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            @include('barangmasuk.formEdit')
                        </form>
                    </div>
                </div>
            </div>
