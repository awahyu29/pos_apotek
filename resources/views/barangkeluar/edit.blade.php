            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">Edit Barang Keluar</h3>
                    </div>
                    <!-- Card body -->
                    <div class="card-body">
                        <form method="POST" action="{{ route('barangmasuk.update', $barangkeluar->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            @include('barangkeluar.formEdit')
                        </form>
                    </div>
                </div>
            </div>
